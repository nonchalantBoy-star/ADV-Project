...
class CryptoPayment(models.Model):
    ...
    crypto_amount = models.DecimalField(max_digits=20, decimal_places=8) # Amount in USDT
    crypto_currency = models.CharField(max_length=10, default='USDT') # Fixed to USDT
